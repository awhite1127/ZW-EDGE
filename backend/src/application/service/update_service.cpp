...
StatusCode UpdateService::get_update_current_version(std::string* result_json, std::string* error_message) const
{
    return run_update_command({"current-version"}, std::chrono::seconds(10), result_json, error_message);
}

StatusCode UpdateService::get_update_status(std::string* result_json, std::string* error_message) const
{
    return run_update_command({"status"}, std::chrono::seconds(10), result_json, error_message);
}

StatusCode UpdateService::validate_update_package(
...
StatusCode UpdateService::start_update_job(
...
StatusCode UpdateService::import_application_upgrade_package(
